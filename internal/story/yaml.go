...
// docs/story-node-yaml.md (PHASES.md §37.A) and ARCHITECTURE.md
// §5-§8.
//
...
// internal/story/nodes_test.go exercise the same parser. Drift
// between them is impossible by construction: there is exactly
// one parser.
//
// LoadStoryNodes is fail-fast at parse and conversion time.
// Authoring typos surface as clear, named errors there rather
// than as silent zero-value drop-through.
...
//
// UnmarshalCondition is exported because event and ending
// YAML (PHASES.md §37.B / §37.E) embed conditions in their
// own records; centralising the dispatch here means one
...
// UnmarshalCondition.
//
// UnmarshalEffect is exported for the same reason as
// UnmarshalCondition: events and endings reference effects
// through TriggerEvent (currently) and Phase 38+ may enrich
// event records with their own effects; the dispatcher lives
// here once.
